  ...
  var Banner = {
    init: function init() {
      ...
      function frame0() {
        ...
        .from(['#bg_img1_wrap', '#head4'], .01, {
          autoAlpha: 0,
          ease: Quart.easeInOut
        }, "+=1.5").set(['#head1', '#logo_wrap'], {
          autoAlpha: 0
        }).to(['#bg_img1_wrap', '#bg_img1_gradient', '#head4'], .01, {
          autoAlpha: 0,
          ease: Quart.easeInOut
        }, "+=2").set('#logo_wrap', {
          autoAlpha: 1
          ...
          autoAlpha: 0,
          ease: Quart.easeOut
        }).staggerFrom(head2b.words, 0.01, {
          autoAlpha: 0
        }, 0.2, "+=" + head2Delay).set(['#head2', '#logo_wrap'], {
          autoAlpha: 0
        }, "+=1.5").to('#bg_img1_wrap', .01, {
          autoAlpha: 1,
          ease: Strong.easeOut
        }).add("uiAnim").from('#img1', .8, {
          y: "+=80",
          autoAlpha: 0,
          ease: Strong.easeOut,
          force3D: false
        }, "uiAnim") // .call(playJson, this, "+=1")
        .call(playAnimation, ["img1"], this, "uiAnim").to(['#bg_img1_wrap', '#img1'], 0.01, {
          autoAlpha: 0,
