    ...
    init: function init() {
      ...
      var animFrames = 35,
        ...
        type: ['words']
          ...
          head2Delay = headDelay(dom.head2a); // log.trace(`head1Delay: ${head1Delay}\nhead2Delay: ${head2Delay}`);
      ...
      function frame0() {
        ...
        tl.from("#head1", 0.75, {
          ...
          autoAlpha: 0
        }, 0.2, "+=" + head1Delay) // .set('#head1',.85,{y:"+=300",ease:Quart.easeInOut},"+=1.5")
        .from(['#bg_img1_wrap', '#head4'], 1, {
          y: "-=700",
          ease: Quart.easeInOut
        }, "+=1.5").set('#head1', {
          autoAlpha: 0
        }, "-=.5").to(['#bg_img1_wrap', '#head4'], 1, {
          y: "-=700",
          ease: Quart.easeInOut
        }, "+=2").set('#bg_img1_gradient', {
          autoAlpha: 0
        }).from('#head2', 0.55, {
          y: "+=80",
          autoAlpha: 0,
          ...
          autoAlpha: 0
        }, 0.2, "+=" + head2Delay).set('#head2', {
          autoAlpha: 0
        }, "+=1.5").to('#bg_img1_wrap', .8, {
          y: 0,
          autoAlpha: 1,
          ease: Strong.easeOut
        }).add("uiAnim", "-=0.8").from('#img1', .8, {
          y: "+=80",
          autoAlpha: 0,
          ease: Strong.easeOut,
          force3D: false
        }, "uiAnim").call(playAnimation, ["img1"], this, "uiAnim").to(['#bg_img1_wrap', '#img1'], 0.7, {
          y: "-=700",
          ease: Power2.easeInOut,
          force3D: false
        }, "+=3").to("#ad_content", 0.5, {
          backgroundColor: "#ffe01b"
        }, "-=0.4").from(['#head3', '#cta'], .6, {
          y: "+=80",
          autoAlpha: 0,
          ease: Quart.easeOut
        }, "-=.35").from("#logo_wrap", 1, {
