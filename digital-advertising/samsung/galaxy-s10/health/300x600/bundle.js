  ...
  var Banner = {
    init: function init() {
      ...
      function frame1() {
        ...
        gsap.from(dom.lid, dur, {
          y: -50,
          rotationX: 35,
          ease: ease
        });
        gsap.from(dom.base, dur, {
          y: -50,
          rotationX: -15,
          ease: ease
        });
        gsap.from(dom.ref, dur, {
          alpha: 0.05,
          y: 40,
          scale: 0.9,
          rotationX: 15,
        ...
        gsap.delayedCall(dur, frame2);
      }

      function frame2() {
        dom.ref_red.classList.remove('invisible');
        dom.base_red.classList.remove('invisible');
        gsap.delayedCall(2, frame3);
      }

      function frame3() {
        dom.ref_red.classList.add('invisible');
        dom.base_red.classList.add('invisible');
        dom.ref_green.classList.remove('invisible');
        dom.base_green.classList.remove('invisible');
      } ////////////////////////////////////////////////////// EVENT HANDLERS //////////////////////////////////////////////////////
      ...
      function onAdHover() {
        // dom.cta.classList.add('cta-hover'); // cta-text
      ...
      function onAdOut() {
        // dom.cta.classList.remove('cta-hover'); // cta-text
        gsap.to(dom.cta_over, 0.25, {
          alpha: 0,
          ease: Cubic.easeIn
        });
