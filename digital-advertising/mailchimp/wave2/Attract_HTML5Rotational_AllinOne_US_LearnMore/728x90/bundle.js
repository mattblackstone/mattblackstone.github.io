    ...
    init: function init() {
      ...
      function frame0() {
        ...
        tl.from("#head1", 0.75, {
          ...
          autoAlpha: 0
        }, 0.2, "+=" + head1Delay).to('#head1', .85, {
          y: "-=300",
          ease: Quart.easeInOut
        }, "+=1.5").to(['#head1', '#head4', '#bg_img1_gradient'], 0.1, {
          autoAlpha: 0
          ...
          autoAlpha: 0
        }, 0.2, "+=" + head2Delay).add("uiAnim", "-=2.5").from('#img1', .8, {
          y: "+=80",
          autoAlpha: 0,
          ease: Strong.easeOut,
          force3D: false
        }, "uiAnim").call(playAnimation, ["img1"], this, "uiAnim").to('#head2', .85, {
          y: "-=300",
          ease: Quart.easeInOut
        }, "+=1.5").to('#head2', 0.1, {
          autoAlpha: 0
