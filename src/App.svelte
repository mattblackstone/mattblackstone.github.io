...
<main>
  ...
  <section>
    <div>
      ...
      <article class="row">
        <img
          src="/images/logo-red-128x128.png"
          alt="RED logo"
          width="64"
          height="64"
          class="logo"
      ...
      <article class="row">
        <img
          src="/images/logo-strava-128x128.png"
          alt="Strava logo"
          width="64"
          height="64"
          class="logo"
        ...
        <div>
          ...
          <p>
            ...
            in vanilla JS and built using React. <a href="/strava"
              >View project</a
            >
          </p>
        </div>
      ...
      <article class="row">
        <img
          src="/images/logo-quad-128x128.png"
      ...
      <article class="row">
        <img
          src="/images/logo-mercedes-128x128.png"
          alt="Mercedes logo"
          width="64"
          height="64"
          class="logo"
        ...
        <div>
          ...
          <p>
            ...
            <a href="/mercedes">View project</a>
          </p>
        </div>
      </article>
      <article class="row">
        <img
          src="/images/logo-disney-128x128.png"
          alt="Disney logo"
          width="64"
          height="64"
          class="logo"
        ...
        <div>
          ...
          <p>
            ...
            templates enabled thousands of variations. <a href="/disney"
              >View project</a
            >
          </p>
        </div>
      ...
      <article class="row">
        <img
          src="/images/logo-mailchimp-128x128.png"
          alt="Mailchimp logo"
          width="64"
          height="64"
          class="logo"
        ...
        <div>
          ...
          <p>
            ...
            cost. <a href="/mailchimp">View project</a>
          </p>
        </div>
      </article>
      <article class="row">
        <img
          src="/images/logo-samsung-128x128.png"
          alt="Samsung logo"
          width="64"
          height="64"
          class="logo"
        ...
        <div>
          ...
          <p>
            ...
            etc) to achieve video quality in a package of around 200k. <a
              href="/digital-advertising/samsung">View examples</a
            >
          </p>
        </div>
      </article>
