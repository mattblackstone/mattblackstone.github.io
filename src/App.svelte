...
<main>
  <header>
    ...
    <span class="address">Bend, OR<br><a
        href="https://www.linkedin.com/in/mattblackstone/">linkedin.com/in/mattblackstone</a></span>
  </header>
  <section>
    <div>
      <h3>Summary</h3>
  ...
  <section>
    <div>
      ...
      <article class="row">
        <img src="/images/logo-quad-128x128.png" alt="GAS React Next Lambda logos" width="64" height="64" class="logo">
        <div>
          <div class="inline-all">
            <h4>R/GA:&nbsp;</h4>
      ...
      <article class="row">
        <img src="/images/logo-mercedes-128x128.png" alt="Mercedes logo" width="64" height="64" class="logo">
        <div>
          <div class="inline-all">
            <h4>Mercedes-Benz:&nbsp;</h4>
      ...
      <article class="row">
        <img src="/images/logo-disney-128x128.png" alt="Disney logo" width="64" height="64" class="logo">
        <div>
          <div class="inline-all">
      ...
      <article class="row">
        <img src="/images/logo-mailchimp-128x128.png" alt="Mailchimp logo" width="64" height="64" class="logo">
        <div>
          <div class="inline-all">
            <h4>Mailchimp:&nbsp;</h4>
      ...
      <article class="row">
        <img src="/images/logo-samsung-128x128.png" alt="Samsung logo" width="64" height="64" class="logo">
        <div>
          <div class="inline-all">
            <h4>Samsung:&nbsp;</h4>
