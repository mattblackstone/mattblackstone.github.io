(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function i(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerpolicy&&(r.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?r.credentials="include":a.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(a){if(a.ep)return;a.ep=!0;const r=i(a);fetch(a.href,r)}})();function c(){}function $(e){return e()}function _(){return Object.create(null)}function m(e){e.forEach($)}function E(e){return typeof e=="function"}function R(e,t){return e!=e?t==t:e!==t||e&&typeof e=="object"||typeof e=="function"}function j(e){return Object.keys(e).length===0}function B(e,t,i){e.insertBefore(t,i||null)}function C(e){e.parentNode.removeChild(e)}function N(e){return document.createElement(e)}function O(e){return Array.from(e.childNodes)}let y;function h(e){y=e}const d=[],A=[],p=[],D=[],P=Promise.resolve();let v=!1;function V(){v||(v=!0,P.then(L))}function w(e){p.push(e)}const g=new Set;let f=0;function L(){const e=y;do{for(;f<d.length;){const t=d[f];f++,h(t),G(t.$$)}for(h(null),d.length=0,f=0;A.length;)A.pop()();for(let t=0;t<p.length;t+=1){const i=p[t];g.has(i)||(g.add(i),i())}p.length=0}while(d.length);for(;D.length;)D.pop()();v=!1,g.clear(),h(e)}function G(e){if(e.fragment!==null){e.update(),m(e.before_update);const t=e.dirty;e.dirty=[-1],e.fragment&&e.fragment.p(e.ctx,t),e.after_update.forEach(w)}}const z=new Set;function T(e,t){e&&e.i&&(z.delete(e),e.i(t))}function q(e,t,i,o){const{fragment:a,after_update:r}=e.$$;a&&a.m(t,i),o||w(()=>{const s=e.$$.on_mount.map($).filter(E);e.$$.on_destroy?e.$$.on_destroy.push(...s):m(s),e.$$.on_mount=[]}),r.forEach(w)}function I(e,t){const i=e.$$;i.fragment!==null&&(m(i.on_destroy),i.fragment&&i.fragment.d(t),i.on_destroy=i.fragment=null,i.ctx=[])}function F(e,t){e.$$.dirty[0]===-1&&(d.push(e),V(),e.$$.dirty.fill(0)),e.$$.dirty[t/31|0]|=1<<t%31}function J(e,t,i,o,a,r,s,M=[-1]){const u=y;h(e);const n=e.$$={fragment:null,ctx:[],props:r,update:c,not_equal:a,bound:_(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(t.context||(u?u.$$.context:[])),callbacks:_(),dirty:M,skip_bound:!1,root:t.target||u.$$.root};s&&s(n.root);let b=!1;if(n.ctx=i?i(e,t.props||{},(l,S,...k)=>{const x=k.length?k[0]:S;return n.ctx&&a(n.ctx[l],n.ctx[l]=x)&&(!n.skip_bound&&n.bound[l]&&n.bound[l](x),b&&F(e,l)),S}):[],n.update(),b=!0,m(n.before_update),n.fragment=o?o(n.ctx):!1,t.target){if(t.hydrate){const l=O(t.target);n.fragment&&n.fragment.l(l),l.forEach(C)}else n.fragment&&n.fragment.c();t.intro&&T(e.$$.fragment),q(e,t.target,t.anchor,t.customElement),L()}h(u)}class W{$destroy(){I(this,1),this.$destroy=c}$on(t,i){if(!E(i))return c;const o=this.$$.callbacks[t]||(this.$$.callbacks[t]=[]);return o.push(i),()=>{const a=o.indexOf(i);a!==-1&&o.splice(a,1)}}$set(t){this.$$set&&!j(t)&&(this.$$.skip_bound=!0,this.$$set(t),this.$$.skip_bound=!1)}}function U(e){let t;return{c(){t=N("main"),t.innerHTML=`<header><div id="me"><h1>Matt Blackstone</h1> 
  ...
  <section><div><h3>Work</h3> 
      ...
      <article class="row"><img src="/images/logo-strava-128x128.png" alt="Strava logo" width="64" height="64" class="logo"/> 
        <div><div class="inline-all"><h4>Strava:\xA0</h4> 
          ...
          <p>An interactive data visualization experience for athletes who use Strava to track their workouts. Strava&#39;s annual Year In Sport is a chance for athletes to review their fitness highlights, progress, summary and share stats with friends. Designed in Figma, prototyped in vanilla JS and built using React. <a href="https://mattblackstone.com/strava">View project</a></p></div></article> 
      ...
      <article class="row"><img src="/images/logo-samsung-128x128.png" alt="Samsung logo" width="64" height="64" class="logo"/> 
        <div><div class="inline-all"><h4>Samsung:\xA0</h4> 
          ...
          <p>Pushing the limits of display advertising using a variety of animation techniques (GSAP, CSS 3D, Canvas, Lottie, Spritesheets etc) to achieve video quality in a package of around 200k. <a href="https://mattblackstone.com/digital-advertising/samsung">View examples</a></p></div></article></div></section> 
  <section id="resume"><div id="experience"><h3>Experience</h3> 
    ...
    <div id="education"><h3>Education</h3> 
      ...
      <p>Areas of study: graphic design, 3D animation, printmaking, color theory, painting, drawing, sculpture, math and science.</p></div></section>`},m(i,o){B(i,t,o)},p:c,i:c,o:c,d(i){i&&C(t)}}}class Y extends W{constructor(t){super(),J(this,t,null,U,R,{})}}new Y({target:document.getElementById("app")});
