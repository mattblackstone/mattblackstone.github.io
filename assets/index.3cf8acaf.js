(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function i(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerpolicy&&(r.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?r.credentials="include":a.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(a){if(a.ep)return;a.ep=!0;const r=i(a);fetch(a.href,r)}})();function c(){}function D(e){return e()}function x(){return Object.create(null)}function p(e){e.forEach(D)}function C(e){return typeof e=="function"}function B(e,t){return e!=e?t==t:e!==t||e&&typeof e=="object"||typeof e=="function"}function N(e){return Object.keys(e).length===0}function E(e,t,i){e.insertBefore(t,i||null)}function L(e){e.parentNode.removeChild(e)}function O(e){return document.createElement(e)}function V(e){return Array.from(e.childNodes)}let b;function h(e){b=e}const d=[],A=[],m=[],$=[],G=Promise.resolve();let v=!1;function P(){v||(v=!0,G.then(M))}function w(e){m.push(e)}const g=new Set;let f=0;function M(){const e=b;do{for(;f<d.length;){const t=d[f];f++,h(t),z(t.$$)}for(h(null),d.length=0,f=0;A.length;)A.pop()();for(let t=0;t<m.length;t+=1){const i=m[t];g.has(i)||(g.add(i),i())}m.length=0}while(d.length);for(;$.length;)$.pop()();v=!1,g.clear(),h(e)}function z(e){if(e.fragment!==null){e.update(),p(e.before_update);const t=e.dirty;e.dirty=[-1],e.fragment&&e.fragment.p(e.ctx,t),e.after_update.forEach(w)}}const T=new Set;function R(e,t){e&&e.i&&(T.delete(e),e.i(t))}function q(e,t,i,o){const{fragment:a,after_update:r}=e.$$;a&&a.m(t,i),o||w(()=>{const s=e.$$.on_mount.map(D).filter(C);e.$$.on_destroy?e.$$.on_destroy.push(...s):p(s),e.$$.on_mount=[]}),r.forEach(w)}function I(e,t){const i=e.$$;i.fragment!==null&&(p(i.on_destroy),i.fragment&&i.fragment.d(t),i.on_destroy=i.fragment=null,i.ctx=[])}function W(e,t){e.$$.dirty[0]===-1&&(d.push(e),P(),e.$$.dirty.fill(0)),e.$$.dirty[t/31|0]|=1<<t%31}function F(e,t,i,o,a,r,s,j=[-1]){const u=b;h(e);const n=e.$$={fragment:null,ctx:[],props:r,update:c,not_equal:a,bound:x(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(t.context||(u?u.$$.context:[])),callbacks:x(),dirty:j,skip_bound:!1,root:t.target||u.$$.root};s&&s(n.root);let y=!1;if(n.ctx=i?i(e,t.props||{},(l,S,...k)=>{const _=k.length?k[0]:S;return n.ctx&&a(n.ctx[l],n.ctx[l]=_)&&(!n.skip_bound&&n.bound[l]&&n.bound[l](_),y&&W(e,l)),S}):[],n.update(),y=!0,p(n.before_update),n.fragment=o?o(n.ctx):!1,t.target){if(t.hydrate){const l=V(t.target);n.fragment&&n.fragment.l(l),l.forEach(L)}else n.fragment&&n.fragment.c();t.intro&&R(e.$$.fragment),q(e,t.target,t.anchor,t.customElement),M()}h(u)}class J{$destroy(){I(this,1),this.$destroy=c}$on(t,i){if(!C(i))return c;const o=this.$$.callbacks[t]||(this.$$.callbacks[t]=[]);return o.push(i),()=>{const a=o.indexOf(i);a!==-1&&o.splice(a,1)}}$set(t){this.$$set&&!N(t)&&(this.$$.skip_bound=!0,this.$$set(t),this.$$.skip_bound=!1)}}function U(e){let t;return{c(){t=O("main"),t.innerHTML=`<header><div id="me"><h1>Matt Blackstone</h1> 
  ...
  <section id="resume"><div id="experience"><h3>Experience</h3> 
      <article><h4>Spectrum</h4> 
        <h5>Senior Frontend Developer (2021 \u2013 present)</h5> 
    ...
    <div id="education"><h3>Education</h3> 
      ...
      <p>Areas of study: graphic design, 3D animation, printmaking, color theory, painting, drawing, sculpture, math and
        science.</p></div></section>`},m(i,o){E(i,t,o)},p:c,i:c,o:c,d(i){i&&L(t)}}}class Y extends J{constructor(t){super(),F(this,t,null,U,B,{})}}new Y({target:document.getElementById("app")});
